...
const Navbar = () => {
    ...
    return (
        <div className="bg-[#fdf0d5] dark:bg-black">
            <div className="navbar lg:p-0 max-w-[1140px] mx-auto mt-5 ">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-4xl font-sedan lg:pl-0 text-[#003049] dark:text-red-400">Alte<span className="text-[#669bbc]">Navi</span></a>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    <a className="btn text-white px-5 font-semibold primary-bg">Login</a>
                </div>
            </div>
        </div>
    );
